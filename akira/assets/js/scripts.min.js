...
//------------------------------acardeon-курсы--------------------------
  $(".box__content").slideUp("slow");
  // $(".box").first().addClass('box--active');
  $(".box--active .box__content").slideDown("slow");
  ...
  $(".box__header").on("click", function(){
    if ($(this).parent().hasClass('box--active')) {
      ...
      $(".box--active .box__content").slideUp("slow");
